 ...
 * 
 * The matrix 3D array is created in matrix.js,  the html representation of this
 * is also created in the matrix.js file. 
 */
...
/*    REPLACED in bubbled listener :  UniversalListener()
...
// listeners set per cell
// This was replaced by bubbled listener: UniversalListener()
...
// bubbled listeners
function UniversalListener() {
    const field = document.querySelector('#FIELD');
    if (LEVEL == 'easy') {
        field.addEventListener('click', getCell)
    }
    else {
        field.addEventListener('click', getCell2)
    }
